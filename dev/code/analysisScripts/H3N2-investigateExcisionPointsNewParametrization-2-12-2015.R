...
write.table(file="/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-meanDistanceGivenNodeOn_sorted.txt", proportionOnFrame.sort, row.names=F, quote=F, sep="\t")
write.table(file="/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-meanDistanceGivenNodeOn.txt", proportionOnFrame, row.names=F, quote=F, sep="\t")


setEPS()
postscript(paste("/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-meanMuDim12.eps", sep="") )
  plot(meanMu.on.dim1[proportionOn < 0.5], meanMu.on.dim2[proportionOn < 0.5], xlim=c(-3,7), ylim=c(-3,3),xlab="Antigenic Dimension 1" , ylab="Antigenic Dimension 2")
  points(meanMu.on.dim1[proportionOn >= 0.5], meanMu.on.dim2[proportionOn >= 0.5], col=4, pch =16)
  legend(5,3, legend=c(expression('p'[i]*' < 0.5'),expression('p'[i]*' >= 0.5')), pch=c(1,16), col=c(1,4))
  abline(v=0, lty=2)
  abline(h=0, lty=2)
dev.off()                 
...
setEPS()
postscript(paste("/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-EDist_on.eps", sep="") )
...
setEPS()
postscript(paste("/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-dim1_on.eps", sep="") )
plot(0, type = "n", xlim = c(-8,10), ylim = c(0, 2), xlab="Antigenic dimension 1", ylab="Density")
for(d in 0:(length(proportionOn)-1) ){
...
setEPS()
postscript(paste("/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript2-12-2015/H3N2/muPlots/H3N2-C3b-mds0_05-boxplot-onMu_probGTE0_5.eps", sep="") )
