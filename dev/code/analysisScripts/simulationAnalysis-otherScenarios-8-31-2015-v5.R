...
indicatorsFilePrefix = c("/Users/charles/Documents/researchData/clustering/simulation-newThinning/stage1-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/stage2-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/stage3-k0_3-rep")
legendText = c("stage 1","stage 2", "stage 3")
outFilename = "/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/H3N2/simulations/stage-k0_3.pdf"



indicatorsFilePrefix = c("/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s5-nb1-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s5-nb2-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s5-nb3-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s5-nb4-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s5-nb5-k0_3-rep")
legendText = c("nbh 1","nbh 2","nbh 3","nbh 4","nbh 5")
outFilename = "/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/H3N2/simulations/n30-s5-k0_3.pdf"



indicatorsFilePrefix = c("/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s10-nb1-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s10-nb2-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s10-nb3-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s10-nb4-k0_3-rep",
                         "/Users/charles/Documents/researchData/clustering/simulation-newThinning/n30-s10-nb5-k0_3-rep")
legendText = c("nbh 1","nbh 2","nbh 3","nbh 4","nbh 5")
outFilename = "/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/H3N2/simulations/n30-s10-k0_3.pdf"


#############################

truePosArray = array(NA, dim=c( length(indicatorsFilePrefix), nrow=length(points), ncol=numReplicates))
falsePosArray = array(NA, dim=c( length(indicatorsFilePrefix), nrow=length(points), ncol=numReplicates))
...
for(run in 1:numReplicates){
  ...
  for(k in 1:length(indicatorsFilePrefix)){
    indicatorsCurExp = read.table(paste( indicatorsFilePrefix[k],run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
    proportionOnCurExp = as.numeric( apply(indicatorsCurExp[-burnIn,-1], 2, mean)  )
  
    for(i in 1:length(points)){
      result = proportionOnCurExp > points[i]
      truePosArray[k,i,run] = sum( result & proportionOn ==1)
      falsePosArray[k, i,run] = sum( result==TRUE & proportionOn ==0)
    }
...
avgtruePosArray = array(NA,dim=c( length(indicatorsFilePrefix), nrow=length(points)))
avgfalsePosArray = array(NA,dim=c( length(indicatorsFilePrefix), nrow=length(points)))

#minus 1 because I don't want to count the root node 
for(k in 1:length(indicatorsFilePrefix)){
  avgtruePosArray[k,] = apply(truePosArray[k,,],1, mean) -1
  avgfalsePosArray[k,] = apply(falsePosArray[k,,],1, mean)
}
...
myColors = c("steelblue1" ,"snow3","orangered", "royalblue4", "seagreen","mediumpurple3"   )


plot( avgtruePosArray[1,]~ avgfalsePosArray[1,], xlim=c(0,15), ylim=c(0,16), type="n", xlab="average number of false positives", ylab="average number of true positives", cex.lab=1.4, cex.axis=1.2)
for(k in 1:length(indicatorsFilePrefix)){
  lines( avgtruePosArray[k,]~ avgfalsePosArray[k,], col=myColors[k], lwd=2)
  #at the p<=0.5 
  points( avgtruePosArray[k,pointsRange]~ avgfalsePosArray[k,pointsRange], col=myColors[k], cex=1.2 , pch=1)
  points( avgtruePosArray[k,51]~ avgfalsePosArray[k,51], pch=16, cex=1.6, col=myColors[k])
}

#abline(h=15, lty=4, lwd=3)
legend(x=8, y=5, legend=legendText, col=myColors[1:length(indicatorsFilePrefix)], cex =1.4, lwd = 4, lty=c(1,1,1))
dev.off()



resultThreshold = data.frame(truePos=avgtruePosArray[,51],falsePos=avgfalsePosArray[,51])

resultThreshold

write.table(resultThreshold, file=paste(outFileName, ".txt",sep="\t"), col=T, row=F, quote=F)

#Statistic used in paper
for(k in 1:length(indicatorsFilePrefix)){
 cat(avgtruePosArray[k,51] , avgfalsePosArray[k,51] ,"\n")
}
