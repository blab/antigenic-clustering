...
truePos0_05 = matrix(nrow=length(points),ncol=10 )
falsePos0_05 = matrix(nrow=length(points),ncol=10 )

truePos0_1 = matrix(nrow=length(points),ncol=10 )
falsePos0_1 = matrix(nrow=length(points),ncol=10 )

truePos0_2 = matrix(nrow=length(points),ncol=10 )
falsePos0_2 = matrix(nrow=length(points),ncol=10 )

truePos0_5 = matrix(nrow=length(points),ncol=10 )
falsePos0_5 = matrix(nrow=length(points),ncol=10 )


truePos0_5_mds0_3 = matrix(nrow=length(points),ncol=10 )
falsePos0_5_mds0_3 = matrix(nrow=length(points),ncol=10 )

truePos0_05_mds0_3 = matrix(nrow=length(points),ncol=10)
falsePos0_05_mds0_3 = matrix(nrow=length(points),ncol=10 )
...
if(run<=5 ){
 indicators0_1 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_1/H3N2_mds.indicatorsStat.log", sep=""), header = T)
 indicators0_05 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_05/H3N2_mds.indicatorsStat.log", sep=""), header = T)
 indicators0_2 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_2/H3N2_mds.indicatorsStat.log", sep=""), header = T)
 indicators0_5 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_5/H3N2_mds.indicatorsStat.log", sep=""), header = T)
 indicators0_5_mds0_3 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_5-mds0_3/H3N2_mds.indicatorsStat.log", sep=""), header = T)
 indicators0_05_mds0_3 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscript/simulation/H3N2/H3N2-rep",run,"-cr0_05-mds0_3/H3N2_mds.indicatorsStat.log", sep=""), header = T)
}
else{
  indicators0_1 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_1-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
  indicators0_05 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_05-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
  indicators0_2 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_2-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
  indicators0_5 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_5-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
  indicators0_5_mds0_3 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_5-mds0_3-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
  indicators0_05_mds0_3 = read.table(paste("/Users/charles/Documents/researchData/clustering/forManuscripts-moreReplicates/simulations/H3N2-cr0_05-mds0_3-rep",run,"/H3N2_mds.indicatorsStat.log", sep=""), header = T)
}
...
proportionOn0_5 = as.numeric( apply(indicators0_5[-burnIn,-1], 2, mean)  )
proportionOn0_5_mds0_3 = as.numeric( apply(indicators0_5_mds0_3[-burnIn,-1], 2, mean)  )
proportionOn0_05_mds0_3 = as.numeric( apply(indicators0_05_mds0_3[-burnIn,-1], 2, mean)  )



resultSummary = data.frame(truth=proportionOn, cr0_5=proportionOn0_5,
        cr0_2= proportionOn0_2, cr0_1= proportionOn0_1, cr0_05= proportionOn0_05
        , cr0_05_mds0_3=proportionOn0_05_mds0_3, cr0_5_mds0_3=proportionOn0_5_mds0_3  )
...
for(i in 1:length(points)){
    ...
    result = proportionOn0_5 > points[i]
    truePos0_5[i,run] =  sum( result & proportionOn ==1)
    falsePos0_5[i,run] =  sum( result==TRUE & proportionOn ==0)

    result = proportionOn0_5_mds0_3 > points[i]
    truePos0_5_mds0_3[i,run] =  sum( result & proportionOn ==1)
    falsePos0_5_mds0_3[i,run] =  sum( result==TRUE & proportionOn ==0)
    
    result = proportionOn0_05_mds0_3 > points[i]
    truePos0_05_mds0_3[i,run] = sum( result & proportionOn ==1)
    falsePos0_05_mds0_3[i,run] = sum( result==TRUE & proportionOn ==0)
...
avgtruePos0_5 = apply(truePos0_5,1, mean)-1
avgtruePos0_05_mds0_3 = apply(truePos0_05_mds0_3,1, mean)-1
avgtruePos0_5_mds0_3 = apply(truePos0_5_mds0_3,1, mean)-1

avgfalsePos0_05 = apply(falsePos0_05,1, mean)
avgfalsePos0_1 = apply(falsePos0_1,1, mean)
avgfalsePos0_2 = apply(falsePos0_2,1, mean)
avgfalsePos0_5 = apply(falsePos0_5,1, mean)
avgfalsePos0_05_mds0_3 = apply(falsePos0_05_mds0_3,1, mean)
avgfalsePos0_5_mds0_3 = apply(falsePos0_5_mds0_3,1, mean)
...
avgtruePos0_05_mds0_3[51]
avgfalsePos0_05_mds0_3[51]

avgtruePos0_5_mds0_3[51]
avgfalsePos0_5_mds0_3[51]
...
plot( avgtruePos0_05~ avgfalsePos0_05, xlim=c(0,15), ylim=c(0,16), type="n", xlab="average number of false positives", ylab="average number of true positives", cex.lab=1.4, cex.axis=1.2)
 lines( avgtruePos0_05~ avgfalsePos0_05, col=myColors[4], lwd=4)
 lines( avgtruePos0_1~ avgfalsePos0_1, col=myColors[3], lty=1, lwd=4)
 lines( avgtruePos0_2~ avgfalsePos0_2, col=myColors[2], lty=1, lwd=4)
 lines( avgtruePos0_5~ avgfalsePos0_5, col=myColors[1], lty=1, lwd=4)
lines( avgtruePos0_05_mds0_3~ avgfalsePos0_05_mds0_3, col=myColors[5], lty=6 , lwd=4)
 lines( avgtruePos0_5_mds0_3~ avgfalsePos0_5_mds0_3, col=myColors[6], lty=6 , lwd=4)
 
#points( avgtruePos0_05_mds0_3~ avgfalsePos0_05_mds0_3, col=1, lty=2 )

#at the p<=0.5 
 points( avgtruePos0_05[pointsRange]~ avgfalsePos0_05[pointsRange], col=myColors[4], cex=1.5 , pch=1)
 points( avgtruePos0_1[pointsRange]~ avgfalsePos0_1[pointsRange], col=myColors[3], lty=1, cex=1.5, pch=1)
 points( avgtruePos0_2[pointsRange]~ avgfalsePos0_2[pointsRange], col=myColors[2], lty=1, cex=1.5, pch=1)
 points( avgtruePos0_5[pointsRange]~ avgfalsePos0_5[pointsRange], col=myColors[1], lty=1, cex=1.5, pch=1)
 points( avgtruePos0_05_mds0_3[pointsRange]~ avgfalsePos0_05_mds0_3[pointsRange], col=myColors[5], lty=1.5 , cex=2, pch=1)
points( avgtruePos0_5_mds0_3[pointsRange]~ avgfalsePos0_5_mds0_3[pointsRange], col=myColors[6], lty=2, cex=1.5, pch=1 )


  points( avgtruePos0_05[51]~ avgfalsePos0_05[51], pch=16, cex=3, col=myColors[4])
  points( avgtruePos0_1[51]~ avgfalsePos0_1[51],  lty=1, pch=16, cex=3, col=myColors[3])
  points( avgtruePos0_2[51]~ avgfalsePos0_2[51],  lty=1, pch=16, cex=3, col=myColors[2])
  points( avgtruePos0_5[51]~ avgfalsePos0_5[51],  lty=1, pch=16, cex=3, col=myColors[1])
  points( avgtruePos0_05_mds0_3[51]~ avgfalsePos0_05_mds0_3[51], lty=1, pch=16, cex=3 , col=myColors[5])
 points( avgtruePos0_5_mds0_3[51]~ avgfalsePos0_5_mds0_3[51],  lty=2, pch=16, cex=3, col=myColors[6] )
...
legend(x=8, y=8, legend=c("50%", "20%", "10%", "5%",  expression(paste("5%, ", kappa, "=0.3")), expression(paste("50%, ", kappa, "=0.3"))), col=myColors, cex =1.4, lwd = 4, lty=c(1,1,1,1,6,6))
