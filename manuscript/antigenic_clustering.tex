...
\begin{figure}[h]
	\centering		
	\includegraphics[width=1\textwidth]{figures/custom/mu-stacked-h3n2-h1n1}
	\caption{\textbf{Stacked plot of the density of antigenic jump distance among nodes with high confidence to be associated with antigenic transitions (i.e. nodes that are inferred to be active in at least 50\% of the MCMC samples ($p_i > 50\%$))  in the default A/H3N2 and A/H1N1 analyses.}
	} 
	\label{stackedMuPlot} 
\end{figure}
