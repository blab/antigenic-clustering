...
First, the Gelman-Rubin statistics on the $p_i$ for each node suggest adequate mixing.
In the A/H1N1 analysis, the Gelman-Rubin statistics for all $p_i$ are all well below 1.2 (Figure S7) under all $\kappa$ considered, which suggests convergence \cite{Yang_evolutionbook}. 
...
In the A/H3N2 analysis, the Gelman-Rubin statistics for all $p_i$ are also well below 1.2 (Figure S8) in the primary analysis ($\kappa = 0.1$).
Under each of $\kappa = 0.05 and 0.15$, all except 2 nodes have Gelman-Rubin statistics well below 1.2 (Gelman-Rubin statistics slightly higher than 1.2 (1.2 - 1.28)).
Second, the Effective Sample Size of the posterior probability statistic reported in Tracer in all 10 replicates ($>700$) also suggest that the chain mixed adequately in our primary A/H3N2 and A/H1N1 analyses.
