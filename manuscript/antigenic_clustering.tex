...
\affil[5]{Fogarty International Center, National Institutes of Health, Bethesda, MD, USA}
...
We explicitly leverage information from virus phylogeny to relate viral evolution to the emergence of major antigenic phenotypes, and in this framework, probabilistically infer branches associated with antigenic transitions. 
This work builds on a recently introduced Bayesian multidimensional scaling technique for antigenic cartography, thereby capturing uncertainty in clustering and cartographic location.
...
In our considered setting, results from simulations suggest that our approach can detect antigenic clusters with high sensitivity ($\sim$90\%), even when the proportion of missing measurements is high (90\%).
Here, we analyze several decades of historical A/H1N1 and A/H3N2 antigenic data and infer circulating antigenic phenotypes. 
...
We believe that this method may have utility in identifying newly arisen antigenic phenotypes and thus may facilitate surveillance efforts.
