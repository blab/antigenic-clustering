...
myColors = c("#1587D1", "#B79447","#D2E4B5", "#C197C8",
             "#9953A5", "#7FB2CA","#3B738C", "#D8CB74","#3B007D", "#EEA269", 
             "#8FC4AD", "#B15822","#366795", "#AB7E29", "#5C8E59", "#E1595C" 
)
...
pdf(file="/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/mu-stacked-h3n2-h1n1.pdf", width=12, height=6)
  grid.arrange(plot1, plot2, ncol=2)
dev.off()

pdf(file="/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/H3N2/mu/mu-stacked-h3n2.pdf", width=6, height=6)
 grid.arrange(plot1,ncol=1)
dev.off()

pdf(file="/Users/charles/Documents/research/antigenic/GenoPheno/driver/clustering/analysisManuscript7-31-2015/H1N1/mu/mu-stacked-h1n1.pdf", width=6, height=6)
